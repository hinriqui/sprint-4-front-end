...
*/
pessoa.nomeCompleto() // Olá! Meu nome é Henrique Costa!
...
pessoa.apresentacao = function(){
    ...
    console.log("Olá, eu sou " + pronome + " " + this.nome + " " + this.sobrenome + ", tenho " + this.idade + " anos, " + this.altura + ", meu peso é " + this.peso + " e, só hoje, eu já caminhei " + this.caminhouQuantosMetros + " " + metrosCaminhados + "!")
}
